...
from ansible_collections.community.generic.plugins.module_utils.waldur.order_runner import (
    OrderRunner,
)
...
DOCUMENTATION = """
---
module: community.generic.os_instance
