...
options:
  ...
  name:
    ...
    required: true
  uuid:
    description: The UUID of the OpenStack network. Use this to identify a specific resource for modification or deletion.
    type: str
    required: false
  tenant:
    type: str
...
RUNNER_CONTEXT = {
    ...
    "update_path": None,
    "retrieve_path": "/api/openstack-networks/{uuid}/",
