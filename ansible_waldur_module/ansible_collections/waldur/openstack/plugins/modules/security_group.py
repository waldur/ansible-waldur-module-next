...
options:
  ...
  name:
    ...
    required: true
  uuid:
    description: The UUID of the OpenStack security group. Use this to identify a specific resource for modification or deletion.
    type: str
    required: false
  tenant:
    type: str
...
- name: Remove an existing OpenStack security group
  ...
  - name: Remove OpenStack security group
    waldur.openstack.security_group:
      ...
      api_url: https://waldur.example.com
      tenant: Tenant name or UUID
- name: Update OpenStack security group - set rules
  hosts: localhost
  tasks:
  - name: Update OpenStack security group
    waldur.openstack.security_group:
      state: present
      name: My-Awesome-OpenStack-security-group
      rules: []
...
RUNNER_CONTEXT = {
    ...
    "update_path": None,
    "retrieve_path": "/api/openstack-security-groups/{uuid}/",
